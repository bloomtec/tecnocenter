...
App::import('Vendor','tcpdf/htmlcolors.php'); 
...
$pdf->SetAuthor('tecnocenter.com.co');
$pdf->SetTitle('TCPDF Example 061');
$pdf->SetSubject('TCPDF Tutorial');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData("logo_cms.jpg", PDF_HEADER_LOGO_WIDTH, $titulo, "tecnocenter.com.co");
...
$pdf->Image("http://chart.apis.google.com/chart?cht=p3&chd=t:60,40
