...
--
-- Servidor: localhost
-- Tiempo de generación: 26-02-2011 a las 19:30:25
...
--
-- Volcar la base de datos para la tabla `tipo_movimientos`
--
...
ALTER TABLE `inventory_movements`
  ...
  ADD CONSTRAINT `deltipodemovimiento` FOREIGN KEY (`tipo_movimiento_id`) REFERENCES `tipo_movimientos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
