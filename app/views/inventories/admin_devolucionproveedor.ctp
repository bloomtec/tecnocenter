...
<?php echo $this->Form->create('Inventory',array("action"=>"movements"));?>
	<fieldset>
 		<legend><?php __('Registrar Devolucion Proveedor'); ?></legend>
	<div class="layer">
		<?php
	...
	<?php 
		...
		echo $this->Form->input('Audit.action',array("type"=>"hidden","value"=>"Devolución Proveedor"));
	...
	<div class="layer">
		...
		echo $this->Form->input('InventoryMovement.tipo_documento_id',array("value"=>"3","type"=>"hidden"));
		?>
	</div>
	</fieldset>
