...
<?php echo $this->Form->create('Inventory',array("action"=>"movements"));?>
	<fieldset>
 		<legend><?php __('Registrar Devolución Cliente'); ?></legend>
	<div class="layer">
		<?php
	...
	<?php 
		...
		echo $this->Form->input('Audit.action',array("type"=>"hidden","value"=>"Devolución Cliente"));
	...
	<div class="layer">
		...
		echo $this->Form->input('InventoryMovement.tipo_documento_id',array("value"=>"4","type"=>"hidden"));
		?>
	</div>
	</fieldset>
