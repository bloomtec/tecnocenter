...
<?php echo $this->Form->create('Inventory',array("action"=>"movements"));?>
	<fieldset>
 		<legend><?php __('Registrar Entrada'); ?></legend>
	<div class="layer">
		<?php
	...
	<div class="layer">
		...
		echo $this->Form->input('Audit.action',array("type"=>"hidden","value"=>"Entradas Varias"));
	...
	<div class="layer">
		...
		echo $this->Form->input('InventoryMovement.tipo_documento_id',array("value"=>"7","type"=>"hidden"));
		?>
	</div>
	</fieldset>
