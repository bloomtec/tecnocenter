...
<?php echo $this->Form->create('Provider');?>
	<fieldset>
		...
		<?php
			...
			//echo $this->Form->input('clasificacion',array("options"=>array("Accesorios"=>"Accesorios","Cables"=>"Cables","Desktop"=>"Desktop","Insumos"=>"Insumos","Otros"=>"Otros","Periféricos"=>"Periféricos","Portátiles"=>"Portátiles","Redes"=>"Redes","Servidores"=>"Servidores","Software"=>"Software")));
		?>
		</div>
		<div class="layer">
		<?php
		...
		echo $this->Form->input('estado_proveedor',array("options"=>array("Activo"=>"Activo","Inactivo"=>"Inactivo")));
		echo $this->Form->input('tipo_regimen',array("options"=>array("Común"=>"Común","Simplificado"=>"Simplificado")));
