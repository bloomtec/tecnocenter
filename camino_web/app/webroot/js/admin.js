		...
		var calculadoraIVA=function(){
			...
			function actualizarCampos(){
				...
				if(isNaN(valorIva)||isNaN(valorIva)){
					...
					$(".valorIva").val(Math.round(valorIva*10000)/100);
					$(".valorBase").val(Math.round(valorBase*10000)/100);
					$("#valorIva").val(Math.round(valorIva*10000)/100);
					$("#valorBase").val(Math.round(valorBase*10000)/100);
				}
		...
		var calcularUtilidad=function(){
			...
			function actualizarUtilidad(){
				...
				if(isNaN(costo)||isNaN(valorVenta)){
					$(".porcentaje").val("0");
					$("#ProductPorcUtilidad").val("0");
				}else{
					var uti=Math.round((1-(costo/(valorVenta-valorIva)))*10000)/100
					$(".porcentaje").val(uti);
					$("#ProductPorcUtilidad").val(uti);
				}
			}
		}();
