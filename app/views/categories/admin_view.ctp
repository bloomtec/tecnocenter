	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'products', 'action' => 'delete', $product['id']), null, sprintf(__('Esta seguro que desea borrar# %s?', true), $product['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('Agregar Producto', true), array('controller' => 'products', 'action' => 'add'));?> </li>
		</ul>
	</div>
</div>
-->