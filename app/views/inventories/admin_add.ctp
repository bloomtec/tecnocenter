<script type="text/javascript">
	window.productsByName=<?php echo json_encode($products);?>;
	window.productsByCodigo=<?php echo json_encode($productsByCodigo);?>;
</script>
<div class="inventories form">
<?php echo $this->Form->create('Inventory',array("action"=>"movements"));?>
	<fieldset>
 		<legend><?php __('Registrar Factura de Compra'); ?></legend>
	<div class="layer">
		<?php
	...
	echo $this->Form->input('InventoryMovement.numero_documento',$afterNumeroDocumento);
		...
		echo $this->Form->input('Audit.action',array("type"=>"hidden","value"=>"Factura de Compra"));
	...
	<div class="layer">
		...
		echo $this->Form->input('InventoryMovement.tipo_documento_id',array("value"=>"1","type"=>"hidden"));
		?>
	</div>
