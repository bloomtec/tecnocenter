...
<?php echo $this->Form->create('Inventory',array("action"=>"movements"));?>
	<fieldset>
 		<legend><?php __('Registrar factura de Venta'); ?></legend>
	<div class="layer">
		<?php
	...
	<div class="layer">
		...
		echo $this->Form->input('Audit.action',array("type"=>"hidden","value"=>"Factura de Venta"));		
	...
	<div class="layer">
		...
		echo $this->Form->input('InventoryMovement.tipo_documento_id',array("value"=>"5","type"=>"hidden"));
		?>
	</div>
	</fieldset>
